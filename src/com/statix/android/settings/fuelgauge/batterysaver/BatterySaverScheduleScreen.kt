...
class BatterySaverScheduleScreen : PreferenceScreenMixin {
    ...
    override val keywords: Int = com.android.settings.R.string.keywords_battery_saver_schedule

    override val highlightMenuKey: Int = com.android.settings.R.string.menu_key_battery
