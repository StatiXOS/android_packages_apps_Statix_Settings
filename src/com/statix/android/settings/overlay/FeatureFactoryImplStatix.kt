...
import com.statix.android.settings.search.SearchFeatureProviderStatixImpl
...
class FeatureFactoryImplStatix : FeatureFactoryImpl() {
  ...
  override val searchFeatureProvider: SearchFeatureProvider = SearchFeatureProviderStatixImpl()
}
