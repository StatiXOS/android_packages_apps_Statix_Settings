...
public class ButtonNavigationSettingsGoogleSearchController extends TogglePreferenceController {
    ...
    ButtonNavigationSettingsGoogleSearchController(
            Context context,
            String str,
            NavigationSettingsGoogleSearchUtil navigationSettingsGoogleSearchUtil) {
        super(context, str);
    ...
    public boolean setChecked(boolean z) {
        return Settings.Secure.putInt(
                this.mContext.getContentResolver(), "search_long_press_home_enabled", z ? 1 : 0);
    }

    @Override
    public int getAvailabilityStatus() {
        return (isFlagEnabled() && this.mNavigationCheckUtil.isOmniSupported(this.mContext))
                ? 0
                : 3;
    }
