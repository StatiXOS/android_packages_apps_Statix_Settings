...
public class GestureNavigationSettingsGoogleSearchController extends TogglePreferenceController {
    ...
    public boolean isChecked() {
        return Settings.Secure.getInt(this.mContext.getContentResolver(), "search_press_hold_nav_handle_enabled", this.mContext.getResources().getBoolean(17891842) ? 1 : 0) == 1;
    }
