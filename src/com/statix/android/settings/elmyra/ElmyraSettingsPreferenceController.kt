...
class ElmyraSettingsPreferenceController(context: Context) : BasePreferenceController(context, KEY_ELMYRA_SETTING) {

    private val prefs = mContext.getDePrefs()
    ...
    override fun getSummary(): CharSequence {
        return if (prefs.getEnabled(mContext)) {
            mContext.getString(R.string.elmyra_settings_entry_summary_on, prefs.getActionName(mContext))
        } else {
