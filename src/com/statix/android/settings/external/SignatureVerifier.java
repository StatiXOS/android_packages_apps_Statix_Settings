...
public abstract class SignatureVerifier {
    ...
    private static byte[] getDigestBytes(String packageName, boolean z) {
        ...
        switch (packageName) {
            case -1379536638:
                if (packageName.equals("com.android.settingslib.router.testapp")) {
                    c = 4;
                    break;
                }
                c = 65535;
            ...
            case -731289169:
                ...
                break;
            case -475355492:
                if (packageName.equals("com.google.android.apps.security.securityhub")) {
                    c = 2;
                    break;
                }
                c = 65535;
                break;
            case 40935373:
                if (packageName.equals("com.google.android.apps.tips")) {
                    c = 0;
                    break;
                }
                c = 65535;
