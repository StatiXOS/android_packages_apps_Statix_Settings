...
import com.statix.android.settings.fuelgauge.batterysaver.BatterySaverGoogleScreen;
...
public abstract class StatixSettingsScreenCollector {
    public static FixedArrayMap get() {
        return new FixedArrayMap(
                1,
                (obj) ->
                        StatixSettingsScreenCollector.init((FixedArrayMap.OrderedInitializer) obj));
    }
